...
namespace PeopleAndOrders.Repository
{
    public class PeopleRepository : IPeopleRepositoryCommon
    {
        ...
        public async Task<People> PostPeople(People people)
        {
            using (SqlConnection con = new SqlConnection(connString))
            {
                using (SqlCommand cmd = new SqlCommand("INSERT INTO People VALUES (@id,@address,@email,@password,@name,@city)", con))
                {
        ...
        public async Task<People> PutPeople(int id, People people)
        {
            id = people.Id;
            using (SqlConnection con = new SqlConnection(connString))
            {
